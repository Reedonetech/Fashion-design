...
const Course = () => {
  return (
    <div className="flex flex-col lg:pt-[2%] lg:px-10 px-[20px] justify-center" id='courses'>
      <div className="w-full bg-white shadow-2xl pt-[70px] px-4 lg:px-[40px] gap-[20px] flex flex-col">
        ...
        <div className="flex flex-col lg:flex-row flex-wrap items-center justify-center gap-[50px] py-10">
          ...
          <div className="flex flex-col items-center p-5 gap-3 max-w-[90vw] lg:max-w-[35vw] border rounded-md shadow hover:shadow-lg transition-all">
            <FaShoppingBag className="w-[30px] h-[30px] lg:w-[60px] lg:h-[60px]" />
          ...
          {/* Course 2 */}
          <div className="flex flex-col items-center p-5 gap-3 max-w-[90vw] lg:max-w-[35vw] border rounded-md shadow hover:shadow-lg transition-all">
            <GiAmpleDress className="w-[30px] h-[30px] lg:w-[60px] lg:h-[60px]" />
          ...
          {/* Course 3 */}
          <div className="flex flex-col items-center p-5 gap-3 max-w-[90vw] lg:max-w-[35vw] border rounded-md shadow hover:shadow-lg transition-all">
            <MdContactEmergency className="w-[30px] h-[30px] lg:w-[60px] lg:h-[60px]" />
