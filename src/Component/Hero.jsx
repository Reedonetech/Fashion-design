  ...
  return (
    <div className=' flex flex-col items-center lg:items-start  lg:h-[63vh]'>
        {/* <div className='flex flex-col items-center justify-center bg-gray-200 p-4 px-[40px] gap-[40px]'> */}
            <img src={img5} className='lg:w-full w-full lg:flex hidden' alt="" />
            {/* <p className='text-[22px] font-serif text-violet-900'>Take your Fashion carear journey Start</p> */}
        {/* </div> */}
        <div className='lg:relative lg:bottom-[350px] lg:left-[50px] lg:shadow-2xl lg:w-[38vw] lg:h-[38vh] p-[30px]'>
            <div className='flex flex-col items-center justify-start p-4 px-[40px] gap-[20px] w-[100%] h-[100%]'>
                <h1 className='text-[30px] w-[35vw] font-bold'>Welcome to Our Fashion Store</h1>
